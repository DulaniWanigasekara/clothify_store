...
A desktop inventory and management application for a clothing store named KAIA Clothing, built with Java-FX and MySQL. A standalone application that automates the operations of a clothing store named KAIA. The system handles product management, inventory updates, supplier and employee records, order processing, basic reporting and represent a complete user friendly point of sale experience.
